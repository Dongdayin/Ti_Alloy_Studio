...
func (a *api) info(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]any{
		...
		"version":  "0.1.3-phase1-r3-offline",
		"engine":   "TiModelCore Native + bundled Atomsk/ASE/spglib/pymatgen/AtomMan cross-check",
		"platform": "Windows x64 standalone offline",
	})
}
